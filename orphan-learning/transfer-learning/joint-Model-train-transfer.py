...
train_protein = prepare_data(data_dir,"./data/train_10_sps",vocab_size_protein,vocab_protein,protein_MAX_size,1)
...
test0_protein = prepare_data(data_dir,"./data/orphan_test_sps",vocab_size_protein,vocab_protein,protein_MAX_size,1)
test0_compound = prepare_data(data_dir,"./data/orphan_test_smile",vocab_size_compound,vocab_compound,comp_MAX_size,0)
test0_IC50 = read_labels("./data/orphan_test_ic50")
...
drug_gru_1 = tflearn.gru(drug_embd,GRU_size_drug,initial_state= drug_init_state_1,trainable=False,return_seq=True,restore=True)
drug_gru_1 = tf.stack(drug_gru_1,1)
drug_gru_2 = tflearn.gru(drug_gru_1, GRU_size_drug,initial_state= drug_init_state_2,trainable=False,return_seq=True,restore=True)
...
model.load('checkpoints-26100')

#model2 = tflearn.DNN(linear, session = model.session)


######## training
model.fit([train_protein,train_compound], {'target': train_IC50}, n_epoch=300,batch_size=8,
