...
clf1 = svm.SVC(C=1, gamma=0.01, probability=True)
clf1.fit(F_re, L_re)
...
clf2 = svm.SVC(C=1, gamma=0.01, probability=True)
...
clf3 = RandomForestClassifier(n_estimators=100, max_depth=50, max_leaf_nodes=50, random_state=0)
clf3.fit(F_re, L_re)
...
clf4 = RandomForestClassifier(n_estimators=50, max_depth=50, max_leaf_nodes=50, random_state=0)
