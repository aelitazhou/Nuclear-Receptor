...
clf1 = svm.SVC(C=0.1, gamma=0.01, probability=True)
clf1.fit(F_re, L_re)
...
clf2 = svm.SVC(C=0.1, gamma=0.01, probability=True)
...
'''
clf3 = RandomForestClassifier(n_estimators=1000, max_depth=None, random_state=0)
clf3.fit(F_re, L_re)
...
clf4 = RandomForestClassifier(n_estimators=3000, max_depth=None, random_state=0)
...
clf6 = KNeighborsClassifier(n_neighbors=8)
